...
**AI 工具 · 开源 · 新闻 · 视频** — 国内国际热门工具分类/排行/对比、GitHub Stars 六领域、每日资讯与六类每日视频。
...
|-----------|------------|-------------------|
| ![首页](og-image.jpg) | 国内国际分类 + 排行对比 | 六类视频 · Stars · 每日热点 |
...
python scripts/fetch_ai_news.py        # 每日新闻
